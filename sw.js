const CACHE='attendance-v8.4-20260911';
const ASSETS=['./','./index.html','./styles.css?v=8.4.0','./app.js?v=8.4.0','./firebase-config.js?v=8.4.0','./cloud-sync.js?v=8.4.0','./manifest.webmanifest','./icon.svg'];
