const CACHE='attendance-v8.2-20260910';
const ASSETS=['./','./index.html','./styles.css?v=8.2.0','./app.js?v=8.2.0','./firebase-config.js?v=8.2.0','./cloud-sync.js?v=8.2.0','./manifest.webmanifest','./icon.svg'];
