const CACHE='attendance-v8.1-20260909';
const ASSETS=['./','./index.html','./styles.css?v=8.1.0','./app.js?v=8.1.0','./firebase-config.js?v=8.1.0','./cloud-sync.js?v=8.1.0','./manifest.webmanifest','./icon.svg'];
